...
import { Contacts, ContactsSchema } from '../../api/clubs/clubs.js';
...
Template.Search_Clubs.onCreated(function onCreated() {
  this.subscribe('Clubs');
  this.messageFlags = new ReactiveDict();
  this.messageFlags.set(displayErrorMessages, false);
  this.context = ClubsSchema.namedContext('Search_Clubs');
});

Template.Search_Clubs.helpers({
